...
function ckcpt() {
    var cpt = '';
    /**
     * 这里用于添加自定义插件（插件文件路径，位置，等等）
     * http://www.ckplayer.com/manual/30/90.htm
     * 
     * @author J.Soon <serdeemail@gmail.com>
     */
    // 加载清晰度切换插件
    cpt += 'definition.swf,2,2,-260,-28,2,1|';
    // 加载弹幕按钮
    cpt += 'barrage.swf,2,2,-320,-36,2,1|';
    return cpt;
}
/*
插件的定义结束
...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        ...
        setup: '1,1,1,1,1,2,0,1,2,0,1,1,200,0,2,1,0,1,1,1,1,10,3,0,1,2,3000,1,0,0,0,1,1,1,1,1,1,250,0,90,0,0,0',
        /*
        ...
        */
        flashplayer: '/tech/m3u8.swf',
        /**
         * 当flashvars里的s=3/4时，也可以把swf文件放在这里
         * 
         * 放在这里的用处是，当m3u8直播流时，能够重新加载m3u8.swf文件（否则视频会加载失败）
         * 
         * @author J.Soon <serdeemail@gmail.com>
         */
